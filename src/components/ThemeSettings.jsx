    ...
    <>
      <div className="bg-half-transparent w-screen fixed nav-item top-0 right-0">
        ...
        w-400">
          ...
          <div className="flex-col border-color p-4 ml-4 border-t-1">
            <p className="font-semibold text-lg ">Thame Option</p>
          ...
          <div className="flex-col border-color p-4 ml-4 border-t-1">
            <p className="font-semibold text-lg ">Thame Colors</p>
